...
insert into tb_review (id,text,movie_id,user_id) values(8,'Revisão 1 do filme 3',3,3);
insert into tb_review (id,text,movie_id,user_id) values(9,'Revisão 2 do filme 3',3,3);
